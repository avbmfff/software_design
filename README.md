...
| История изменений (Change history) | Лог изменений, сделанных с задачей | Дата изменения, пользователь, измененные атрибуты | Задача | Записать изменения, просматривать историю |
...
| Управление проектами | В этом случае пользователь будет ответственным. Он будет следить за выполнением задач, но не редактировать их | User<br> • name<br> • nikname <br><br> Project<br> • name<br> • contrebutors<br> • tasks<br> • description<br> • startDate<br> • endDate<br> • status<br><br> Task<br> • name<br> • contrebutor<br> • startDate<br> • endDate<br> • status<br> • description<br> • priority<br> • taskTimeLog |
...
| Проект (Project) | • ID: UUID<br> • Имя: String<br> • Описание: String<br> • Дата начала: Date<br> • Дата окончания: Date<br> • Статус: String<br> • Список задач: List<UUID> | Логическая сущность, объединяющая пользователей и задачи. | Управление проектами |
| Задача (Task) | • ID: UUID<br> • Имя: String<br> • Статус: String<br> • Исполнитель: UUID<br> • Сроки выполнения: Date<br> • Приоритет: String<br> • Описание: String<br> • История изменений: List<UUID> | Единица работы, назначенная пользователю в рамках проекта. | Управление задачами, Управление проектами |
| История изменений (Change history) |  • ID: UUID<br> • Дата изменения: Date<br> •  Пользователь: UUID<br> • Измененные атрибуты: String | Лог изменений, сделанных с задачей. | Управление задачами |
| Время выполнения задачи (Task time log) |  • ID: UUID<br> • Дата начала работы: Date<br> • Дата окончания работы: Date<br> • Потраченное время: Duration | Время, затраченное на выполнение задачи. | Управление задачами |
...
|-|-|-|
| ‣ | User | <Укажите контекст> |
| ‣ | Project | <Укажите контекст> |
...
| Сущность | Атрибуты | Пояснения, если необходимы по вашему мнению | Контекст |
|-|-|-|-|
|  |  | Что-то, что уже было. Что-то новое |  |
...
|-|-|-|-|
| User | • ID: UUID<br> • nickname: String <br> • name: String |  | <Укажите контекст> |
|  |  |  |  |
|  |  |  |  |