...
|-|-|-|-|
| Пользователь (User) | • ID: int<br> • Имя: String<br> •  Никнейм: String<br> • Пароль: String | Существующий (зарегистрированный) пользователь системы. | Управление задачами, Управление проектами, Взаимодействие с системой |
| Проект (Project) | • ID: int<br> • Имя: String<br> • Описание: String<br> • Автор проекта: int<br> • Дата начала: Date<br> • Дата окончания: Date<br> • Список участников: List\<int\><br> • Список задач: List\<int\><br> • Логи: List\<int\> | Логическая сущность, объединяющая пользователей и задачи. | Управление проектами |
| Задача (Task) | • ID: int<br> • Имя: String<br> • Статус: String<br> • Автор задачи: int<br> • Исполнитель: List\<int\><br> • Сроки выполнения: Date<br> • Приоритет: String<br> • Описание: String<br> • Логи: List\<int\> | Единица работы, назначенная пользователю в рамках проекта. | Управление задачами, Управление проектами |
| Логи (Change log) |  • ID: int<br> • Автор изменений: int<br> • Дата изменения: Date<br> • Время работы: int<br> • Измененные атрибуты: String | Лог изменений, сделанных с любой сущностью (проекты или задачи). | Управление задачами, Управление проектами |
...
Дополните таблицу новыми контекстами, если требуется<a id="контексты"></a>

| Название контекста | Кратное пояснение, если требуется | Язык контекста |
|-|-|-|
| Управление проектами | В этом случае пользователь будет ответственным. Он будет следить за выполнением задач, но не редактировать их | User<br> • name<br> • nikname <br><br> Project<br> • name<br> • contrebutors<br> • tasks<br> • description<br> • startDate<br> • endDate<br> • __statusForTasks__<br> • __defaultStatus__<br><br> Task<br> • name<br> • contrebutor<br> • startDate<br> • endDate<br> • __status__<br> • description<br> • priority<br> • taskTimeLog |

[Вернуться к лабораторной 6](#backto61)
...
| Сущность | Атрибуты | Пояснения, если необходимы по вашему мнению | Контекст |
|:-:|-|-|-|
| Проект (Project) | • ID: int<br> • Имя: String<br> • Описание: String<br> • Автор проекта: int<br> • Дата начала: Date<br> • Дата окончания: Date<br> • Список участников: List\<int\><br> • Список задач: List\<int\><br> • Логи: List\<int\><br> • __Список статусов для задач:__ List\<String\><br> • __Статус по умолчанию:__ String | Логическая сущность, объединяющая пользователей и задачи. | Управление проектами |
...
|-|-|-|
| 1.“Гость” имеет возможность узнать зарегистрирован ли пользователь с подобным ником, направив запрос в систему и получив ответ в формате “true/false”.<br> 2.Пройти регистрацию в системе, сменив статус “гостя” на “пользователя” системы, передав никнейм, имя и пароль.<br>3. Пользователь, имеющий аккаунт в системе, имеет возможность авторизации.<br><br>Подробнее о требованиях можно узнать по ссылккам: [1](#фт1), [2](#фт2), [3](#фт3) | User<br>Происходит процесс регистрации, авторизации, аутентификации, идентификации. Гость становится зарегестрированным пользователем<br>ACID | Взаимодействие с системой |
| 8. Найти других пользователей в системе, предав имя или никнейм пользователя <br><br>Подробнее о требованиях можно узнать по ссылккам: [8](#фт8) | User<br>Поиск пользователей в системе<br>Strong consistency | Взаимодействие с системой |
| 4. Авторизованный пользователь может увидеть все проекты, в которых он участвует. <br>5.Авторизованный пользователь может увидеть проекты, где пользователь указан в качестве участника<br><br>Подробнее о требованиях можно узнать по ссылккам: [4](#фт4), [5](#фт5) | User, Project<br>Поиск проектов ассоциированных с пользователем<br>Strong consistency | Управление проектами |
| 6. Создать проект, передав название проекта<br><br>Подробнее о требованиях можно узнать по ссылккам: [6](#фт6) | Project<br>Создание проекта<br>ACID | Управление проектами |
| 7. Добавить других пользователей к проекту, передав ID проекта и пользователя<br><br>Подробнее о требованиях можно узнать по ссылккам: [7](#фт7) | Project<br>Добавление пользователей к проекту<br>ACID | Управление проектами |
| 14.Участники проекта имеют возможность задать статусы для задач в проекте, передав название и цвет<br> 15. Участники проекта имеют возможность изменить статусы для задач в проекте, передав название и цвет<br><br>Подробнее о требованиях можно узнать по ссылккам: [14](#фт14), [15](#фт15) | Project, Task<br>Задание/Изменение статусов для задач проекта<br>ACID | Управление проектами, Управление задачами |
| 16. Участники проекта имеют возможность удалить статусы для задач в проекте, передав название и цвет<br><br>Подробнее о требованиях можно узнать по ссылккам: [16](#фт16) | Project, Task<br>Удаление статусов для задач проекта<br>ACID | Управление проектами, Управление задачами |
| 9. Создать задачу, передав название задачи, ID проекта и пользователя-создателя задачи, информацию о задаче<br> 10. Редактировать задачу, передав ID задачи, новое имя задачи, информацию о задаче и ID пользователя-редактора задач<br><br>Подробнее о требованиях можно узнать по ссылккам: [9](#фт9), [10](#фт10) | Task<br>Создание/Редактирование задачи<br>ACID | Управление задачами |
| 11. Добавить исполнителей к задачи, передав ID задачи и ID пользователей<br><br>Подробнее о требованиях можно узнать по ссылккам: [11](#фт11) | User, Task<br>Добавление исполнителей к задаче<br>ACID | Управление задачами |
| 12. Изменить статус задачи, передав ID задачи и новый статус<br><br>Подробнее о требованиях можно узнать по ссылккам: [12](#фт12) | Task<br>Изменение статусов задачи<br>ACID | Управление задачами |
| 13. Любой участник проекта может удалить любую задачу проекта.<br><br>Подробнее о требованиях можно узнать по ссылккам: [13](#фт13) | Task<br>Удаление задачи<br>ACID | Управление задачами |

[Вернуться к лабораторной 6](#backto62)
...
|-|-|-|-|
| Пользователь (User) | • ID: int<br> • Имя: String<br> • Никнейм: String <br> • Пароль: String | Существующий (зарегистрированный) пользователь системы. | Управление задачами, Управление проектами, Взаимодействие с системой |
| Проект (Project) | • ID: int<br> • Имя: String<br> • Описание: String<br> • Автор проекта: int<br> • Дата начала: Date<br> • Дата окончания: Date<br> • Список участников: List\<int\><br> • Список задач: List\<int\><br> • Логи: List\<int\><br><span style="color:green"> • Список статусов для задач: List\<String\><span> <br> • Статус по умолчанию: String | Логическая сущность, объединяющая пользователей и задачи. | Управление проектами |
| Задача (Task) | • ID: int<br> • Имя: String<br> • Статус: String<br> • Автор задачи: int<br> • Исполнитель: List\<int\><br> • Сроки выполнения: Date<br> • Приоритет: String<br> • Описание: String<br> • Логи: List\<int\><br> • Логи: List\<int\> | Единица работы, назначенная пользователю в рамках проекта. | Управление задачами, Управление проектами |
| Логи (Change log) |  • ID: int<br> • Автор изменений: int<br> • Дата изменения: Date<br> • Время работы: int<br> • Измененные атрибуты: String | Лог изменений, сделанных с задачей или с проектами. | Управление задачами, Управление проектами |
...
|-|-|-|-|-|
| 2.Пройти регистрацию в системе, сменив статус “гостя” на “пользователя” системы, передав никнейм, имя и пароль.<br><br>Подробнее о требованиях можно узнать по ссылккам: [2](#фт2) | User: никнейм, имя и пароль  | createUser(id, nickname, name, password) | UserCreatedEvent | Да (поиск пользвателей) |
| 6. Создать проект, передав название проекта<br><br>Подробнее о требованиях можно узнать по ссылккам: [6](#фт6) | Project: название | createProject(id, title, creatorId) | ProjectCreatedEvent | Да (список проектов) |
| 7. Добавить других пользователей к проекту, передав ID проекта и пользователя<br><br>Подробнее о требованиях можно узнать по ссылккам: [7](#фт7) | Project: ID проекта, user | addUserToProject(projectId, userId) | UserAddedToProjectEvent | Да(когда отображаем информацию о проекте) |
| 9. Создать задачу, передав название задачи, ID проекта и пользователя-создателя задачи, информацию о задаче<br><br>Подробнее о требованиях можно узнать по ссылккам: [9](#фт9) | Task: название задачи, ID проекта, user-автор, статус, user-исполнители, сроки выполнения, приоритет, описание | createTask(id, title, creatorId, status, doersID, deadlines, priority, description) | TaskCreatedEvent | Да (список задач) |
| 10. Редактировать задачу, передав ID задачи, новое имя задачи, информацию о задаче и ID пользователя-редактора задач<br><br>Подробнее о требованиях можно узнать по ссылккам: [10](#фт10) | Task: название задачи, ID проекта, user-редактор, сроки выполнения, приоритет, описание | updateTask(id, title, creatorId, deadlines, priority, description) | TaskContentUpdatedEvent | Да (список задач, история изменения) |
| 11. Добавить исполнителей к задачи, передав ID задачи и ID пользователей<br><br>Подробнее о требованиях можно узнать по ссылккам: [11](#фт11) | Task: ID задачи, ID пользователя| addUserToTask(taskId, userId) | UserAddedToTaskEvent | Да(когда отображаем информацию о задаче, история изменения)
| 12. Изменить статус задачи, передав ID задачи и новый статус<br><br>Подробнее о требованиях можно узнать по ссылккам: [12](#фт12) | Task: ID задачи, новый статус | updateTask(id, status) | TaskStatusUpdatedEvent | Да (список задач, история изменения) |
| 13. Любой участник проекта может удалить любую задачу проекта.<br><br>Подробнее о требованиях можно узнать по ссылккам: [13](#фт13) | Task: ID задачи | deleteTask(id, deleterId) | TaskDeletedEvent | Да (история изменения)
| 14. Участники проекта имеют возможность задать статусы для задач в проекте, передав название и цвет<br><br>Подробнее о требованиях можно узнать по ссылккам: [14](#фт14) | Project: List\<String\> | createProjectStatus(id, statusNameAndColor) | ProjectStatusAddedEvent | Да(отображение статусов)
| 15. Участники проекта имеют возможность изменить статусы для задач в проекте, передав название и цвет<br><br>Подробнее о требованиях можно узнать по ссылккам: [15](#фт15) | Project: List\<String\> | updateProjectStatus(id, statusNameAndColor) | ProjectStatusUpdateEvent | Да(отображение статусов)
| 16. Участники проекта имеют возможность удалить статусы для задач в проекте, передав название и цвет<br><br>Подробнее о требованиях можно узнать по ссылккам: [16](#фт16) | Project: List\<String\> | updateProjectStatus(id, statusNameAndColor) | ProjectStatusUpdateEvent | Да(отображение статусов)
...
6. После одобрения проекций ментором - реализуйте проекции с помощью библиотеки Tiny Event Sourcing.

## Выполнение лабораторной
Первые 3 пункта были выполнены в предыдущей лабораторной работе, так что перейдем к пунктам 4 и 5
<a id="backto61"></a>
#### [1.  Составьте список запросов, которые отвечают за чтение данных](#контексты):
##### Ограниченные контексты
Заполните таблицу<a id="контексты"></a>
| Название контекста | Краткое пояснение, если требуется | Язык контекста |
|-|:-|-|
| Взаимодействие с системой | Действия, не связанные напрямую с проектами и задачами, совершаемые пользователем в системе | User<br> • ID<br> • name<br> • nikname<br> • password |
| Управление задачами | При выполнении задачи пользователь будет исполнителем. Соответственно, исполнитель будет изменять статус задачи и работать над ней | User<br> • name<br> • nikname <br><br> Task<br> • name<br> • status<br> • startDate<br> • endDate<br> • priority<br> • description<br> • taskTimeLog|
...
| Контекст | Операция и агрегаты (перечислены в скобках) |
|-|-|
| Взаимодействие с системой | • getUserByNickname(nickname)<br>• createUser(id, nickname, name, password) <br>• login(nickname, password)<br>• getUserByNickname(nickname) |
| Управление проектами | • addProject(name, description, author, startDate, endDate, users, tasks, statuses, defaultStatus)<br> • updateProject(id, name, description, users, tasks, startDate, endDate, logs, statuses, defaultStatus)<br> • getAllProjects()<br> • getUserProjects(id)<br> • deleteProject(id) |
| Управление задачами | • addTask(name, status, author, duration, users, priority, description, logs)<br> • updateTask(id, name, description, status, users, duration, priority, logs)<br> • getAllTasks()<br> • getTaskById(id)<br> • deleteTask(id) |

> **Теория**
> Проекция - некоторое отображение данных, производная структура, которая строится на основе событий, которые мы получаем из message broker (или event log'а)
> 
> Каждая проекция может обслуживать определенные запросы. Например, есть таблица задач/сущности (по сути, последние актуальные данные задачи из бд). По ней смотрим запросы с задачами
> 
> Event log - все изменения над задачей/сущностью
> 
> Соответственно, по проекции очень удобно выполнять запросы sql
> 
> Проекции могут содержать не все данные о сущности (например, только статистику выполнения задачи или только просмотр исполнителей задачи)
> 
> Так что можно проекцию назвать репликой части данных

#### 4. Опишите проекции, которые могут помочь вам в обслуживании запросов. Опишите структуры данных и способы, которые вы предлагаете для построения данной проекции.

Нам нужны следующие проекции:
