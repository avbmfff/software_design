...
| Проект (Project) | • ID: UUID<br> • Имя: String<br> • Описание: String<br> • Автор проекта: UUID<br> • Дата начала: Date<br> • Дата окончания: Date<br> • Статус: String<br> • Список задач: List\<UUID\> | Логическая сущность, объединяющая пользователей и задачи. | Управление проектами |
