...
| Задача (Task) | Единица работы в проекте, назначенная пользователю | Имя задачи, статус, исполнитель, сроки выполнения, приоритет, описание, тип задачи, история изменений, время на задачу | Проект, пользователь, исполнитель, статус | Создать задачу, назначить исполнителя, изменить статус задачи, редактировать задачу, удалять задачу, добавлять комментарии, логировать время |
| Комментарий (Comment) | Сообщение, оставляемое пользователем для пояснений к задаче | Текст комментария, автор комментария, дата добавления | Задача, пользователь | Добавить комментарий, просматривать комментарии |
| Уведомление (Notification) | Оповещение пользователя о событиях в проекте или задаче | Текст уведомления, тип уведомления (система/внешний сервис), отправитель, получатель | Пользователь, проект, задача | Отправить уведомление, подписаться на уведомления, получить уведомление |
...
| Время выполнения задачи (Task time log) | Время, затраченное на выполнение задачи | Дата начала работы, дата окончания работы, потраченное время | Задача, исполнитель | Логировать время работы, просматривать затраченное время |
